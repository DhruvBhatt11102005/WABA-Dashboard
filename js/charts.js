        ...
        datasets: [
          {
            ...
            data: sentData,
            borderColor: '#7C3AED',
            backgroundColor: makeGradient(ctx.getContext('2d'), '#7C3AED'),
            borderWidth: 2.5,
            tension: 0.45,
            fill: true,
            pointRadius: 4,
          ...
          },
          {
            ...
            data: delivData,
            borderColor: '#0284C7',
            backgroundColor: makeGradient(ctx.getContext('2d'), '#0284C7'),
            borderWidth: 2.5,
            tension: 0.45,
            fill: true,
            pointRadius: 4,
          ...
          },
          {
            ...
            data: readData,
            borderColor: '#EC4899',
            backgroundColor: makeGradient(ctx.getContext('2d'), '#EC4899'),
            borderWidth: 2.5,
            tension: 0.45,
            fill: true,
            pointRadius: 4,
